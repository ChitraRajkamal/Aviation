...
@section('title', __('Add Recorded Video Category'))

@section('page-header')
    @include('layouts.admin.page-header', [
        'icon' => 'ph ph-plus-square text-muted',
        'title' => __('Add Recorded Video Category'),
        'breadcrumbs' => [
...
@section('content')
<form id="saveForm" class="autoSubmit" action="{{ route('admin.recorded-video-categories.store') }}" method="POST" enctype="multipart/form-data" data-parsley-validate>
    @csrf
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="title" value="{{ old('title')}}" placeholder="{{__('Enter Category Title')}}" @lmsparsley(recorded_video_categories,title)>
                        @error('title')
                    ...
                    <div class="form-group d-none">
                        ...
                        <select class="form-control select-two" id="parent_id" data-placeholder="Choose Parent Category" name="parent_id" @lmsparsley(recorded_video_categories,parent_id)>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <textarea name="description" class="form-control" rows="4" placeholder="{{__('Enter Category Description')}}" @lmsparsley(recorded_video_categories,description)>{{ old('description')}}</textarea>
                        @error('description')
                            <div class="parsley-errors-list">{{ $message }}</div>
                        @enderror
                    </div>
