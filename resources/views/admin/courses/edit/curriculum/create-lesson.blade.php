                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select-two" id="lesson_type" data-placeholder="Choose Lesson Type"
                                ...
                                @foreach (lms_lesson_type() as $k => $item)
                                    <option value="{{ $k }}" {{ old('lesson_type') == $k ? 'selected' : '' }}>{{ $item }}</option>
                                @endforeach
                            </select>
                            @error('lesson_type')
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="title" value="{{ old('title')}}" placeholder="{{__('Enter Lesson Title')}}" @lmsparsley(lessons_add,title)>
                            @error('title')
                                <div class="parsley-errors-list">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="row">
                    <div class="col-md-6 all-cont youtube-cont vimeo-cont dailymotion-cont mp4-cont google-cont iframe-cont">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="lesson_src" value="{{ old('lesson_src')}}" placeholder="{{__('Enter Url')}}" @lmsparsley(lessons_add,lesson_src)>
                            @error('lesson_src')
                                <div class="parsley-errors-list">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select-two" id="document_type" data-placeholder="Choose Document Type" name="document_type" @lmsparsley(lessons_add, document_type)>
                                ...
                                @foreach (lms_document_type() as $k => $item)
                                    <option value="{{ $k }}" {{ old('document_type') == $k ? 'selected' : '' }}>{{ $item }}</option>
                                @endforeach
                            </select>
                            @error('document_type')
                                <div class="parsley-errors-list">{{ $message }}</div>
                    ...
                    <div class="col-md-6 all-cont youtube-cont vimeo-cont dailymotion-cont mp4-cont google-cont upload-cont">
                        <div class="form-group">
                            ...
                            value="{{ old('duration')}}" placeholder="{{__('01:30:00 ==> One Hour & 30 Minutes')}}" @lmsparsley(lessons_add,duration)>
                            @error('duration')
                                <div class="parsley-errors-list">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea id="summary" name="summary" class="form-control" rows="4" @lmsparsley(courses_add,summary)>{{ old('summary')}}</textarea>
                            @error('summary')
                                <div class="parsley-errors-list">{{ $message }}</div>
                            @enderror
                        </div>
