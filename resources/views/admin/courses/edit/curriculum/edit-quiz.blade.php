                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="title" value="{{ old('title', $lesson->title)}}" placeholder="{{__('Enter Lesson Title')}}" @lmsparsley(quizs_add,title)>
                            @error('title')
                                <div class="parsley-errors-list">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            value="{{ old('duration', $lesson->duration)}}" placeholder="{{__('01:30:00 ==> One Hour & 30 Minutes')}}" @lmsparsley(quizs_add,duration)>
                            @error('duration')
                                <div class="parsley-errors-list">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            value="{{ old('total_mark', $lesson->total_mark)}}" placeholder="{{__('Total available marks')}}" @lmsparsley(quizs_add,total_mark)>
                            @error('total_mark')
                                <div class="parsley-errors-list">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            value="{{ old('pass_mark', $lesson->pass_mark)}}" placeholder="{{__('Totals marks needed to pass')}}" @lmsparsley(quizs_add,pass_mark)>
                            @error('pass_mark')
                                <div class="parsley-errors-list">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            value="{{ old('retake', $lesson->retake)}}" placeholder="{{__('How many reattempts are allowed. Set 0 if unlimited retakes')}}" @lmsparsley(quizs_add,retake)>
