...
@section('page-header')
    @include('layouts.admin.page-header', [
        ...
        'title' => $recordedVideo->title . ' - ' . __('Ratings'),
        'breadcrumbs' => [
            route('admin.recorded-videos.index') => __(key: 'Recorded Video'),
            '#' => __('Ratings')
        ],
        'links' => [
            lms_can_access('admin.recorded-videos.index') ? generate_link_element([
                'action' => 'back',
...
<script>
    $('.menu_recorded_videos').addClass('active');
</script>
@endsection