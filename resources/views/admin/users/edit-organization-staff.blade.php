...
@section('title', __('Edit Organization Staff'))

@section('page-header')
    @include('layouts.admin.page-header', [
        'icon' => 'ph ph-note-book text-muted',
        'title' => __('Edit Organization Staff'),
        'breadcrumbs' => [
            route('admin.users.organizations') => __('Organizations'),
            '#' => __('Staff'),
        ],
        'links' => [
...
@section('content')
    <form id="saveForm" class="autoSubmission" action="{{ route('admin.users.organization.staff.save', ['organizationId' => $user->organization_id]) }}" method="POST" data-parsley-validate>
        @csrf
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control select-two" id="role_id" name="role_id" data-placeholder="Choose Role">
