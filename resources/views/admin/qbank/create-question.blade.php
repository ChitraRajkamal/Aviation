                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea id="title" name="title" class="form-control" rows="4" @lmsparsley(qbank_questions_add,title)>{{ old('title')}}</textarea>
                            @error('title')
                    ...
                    <div class="col-md-4">
                        @php
                            ...
                            value="{{ old('marks')}}" placeholder="{{__('Marks Allocated')}}" @lmsparsley(qbank_questions_add,marks)>
                            @error('marks')
                                <div class="parsley-errors-list">{{ $message }}</div>
                            @enderror
                        </div>*/
                        ...
                        <div class="form-group all-cont multiple-cont">
                            ...
                            <input type="text" class="form-control" id="multiple_options" name="multiple_options" placeholder="Add Options and hit ENTER"
                              value="{{ old('multiple_options')}}" placeholder="{{__('Enter Course Title')}}" @lmsparsley(qbank_questions_add,multiple_options)>
                        ...
                        <div class="form-group all-cont fill-cont">
                            ...
                            <input type="text" class="form-control" name="fill_answer" value="{{ old('fill_answer')}}" placeholder="{{__('Enter Answer')}}" @lmsparsley(qbank_questions_add,fill_answer)>
                            @error('fill_answer')
                                <div class="parsley-errors-list">{{ $message }}</div>
                            @enderror
                        </div>
