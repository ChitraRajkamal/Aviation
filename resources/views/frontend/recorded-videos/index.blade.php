...
@section('title', 'Recorded Videos')
@php
    $total_courses = $recordedVideos->total();
@endphp
...
<style>
    ...
    /* .bg_image{
        background-image: url({{asset('assets/images/breadcrumb/video-banner.png')}});
    } */
</style>
<!-- bread crumb area -->
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb-main-wrapper">
                    <h1 class="title">Recorded Videos</h1>
                    <!-- breadcrumb pagination area -->
                    <div class="pagination-wrapper">
                        <a href="{{url('')}}">Home</a>
                        <i class="fa-regular fa-chevron-right"></i>
                        <a class="active">All Recorded Videos</a>
                    </div>
                ...
                <form action="">
                    ...
                    <div class="rts-course-filter-area">
                        ...
                        <div class="single-filter-left-wrapper">
                            ...
                            <div class="search-filter filter-body">
                                <div class="input-wrapper">
                                    <input type="text" name="query" value="{{$filter['query']}}" placeholder="Search videos...">
                                ...
                                <div class="checkbox-wrapper">
                                    @foreach ($categories as $key => $item)
                                        ...
                                        <div class="single-checkbox-filter">
                                            ...
                                            <span class="number">({{$item->recorded_videos_count }})</span>
                                        </div>
                        ...
                        <div class="single-filter-left-wrapper">
                            ...
                            <div class="checkbox-filter filter-body">
                                <div class="checkbox-wrapper">
                                    @foreach (lms_recorded_video_pricing() as $key => $is_paid)
                                        <!-- single check box -->
                                        <div class="single-checkbox-filter">
                                            <div class="check-box">
                        ...
                        @if (request('search', false))
                            <a href="{{route('recorded-videos')}}" class="rts-btn btn-border"><i class="fa-regular fa-x"></i> Clear All Filters</a>
                        @endif                        
                    </div>
            ...
            <div class="col-lg-9">
                ...
                <div class="filter-small-top-full">
                    <div class="left-filter">
                        <span>{{$total_courses}} recorded {{lms_plural('video', $total_courses)}} found</span>
                    </div>
                    ...
                    @if ($viewType == 'grid')
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="grid-view-tab">
                            <div class="row mt-0 g-5">
                                @foreach ($recordedVideos as $item)
                                    @php
                                        $lesson_count = 0;
                                        $url = lms_recorded_video_slug($item);
                                    @endphp
