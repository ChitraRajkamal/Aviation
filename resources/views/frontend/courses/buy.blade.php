...
@section('title', 'Buy - ' . $course->title)
            ...
            <div class="col-lg-12">
                <div class="single-course-left-align-wrapper">
                    <div class="meta-area">
                        ...
                        <i class="fa-solid fa-chevron-right"></i>
                        <a href="{{lms_course_slug($course)}}">{{$course->title}}</a>
                        <i class="fa-solid fa-chevron-right"></i>
                    ...
                    <div class="author-area mt-1">
                        ...
                        <p class="mb-0"> <span>Category: </span> {{$course->category->title}}</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-8">
                <div class="text-center">
                    <div class="course-prepare-info-each">
                        <label>Amount</label>
                        <span class="fa-2x">{{$course->price}}</span>
                    </div>
                    ...
                    <div class="course-side-bar">
                        ...
                        <div class="price-area">
                            ...
                            @if ($course->discount_flag)
                                ...
                                <h4 class="none">{!!lms_show_price($course)!!}</h4>
                                <span class="discount">-{{(100 - round(($course->discounted_price/$course->price) * 100, 2))}}%</span>
                            @else
...
<script>
    var options = {
        ...
        "description": "{{lms_setting('app_name')}} - Exam Payment - {{$course->title}}",
                ...
                setTimeout(() => {
                    ...
                    $.post('{{route('ajax.verify_razorpay_payment')}}', {
                        ...
                        if (data.status == 'error') {
                            ...
                            setTimeout(() => {
                                show_loader();
                                window.location.href = "{{lms_course_slug($course)}}";
                            }, 3000);
                        }
                    }, 'JSON');
                }, 100);
