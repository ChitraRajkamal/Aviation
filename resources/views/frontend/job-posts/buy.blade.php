...
@section('title', 'Buy - ' . $jobPost->title)
            ...
            <div class="col-lg-12">
                <div class="single-course-left-align-wrapper">
                    <div class="meta-area">
                        ...
                        <a href="{{route('job-posts')}}">Job Posts</a>
                        <i class="fa-solid fa-chevron-right"></i>
                        <a href="{{lms_job_post_slug($jobPost)}}">{{$jobPost->title}}</a>
                        <i class="fa-solid fa-chevron-right"></i>
                    ...
                    <div class="author-area mt-1">
                        ...
                        <p class="mb-0"> <span>Category: </span> {{$jobPost->category->title}}</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-8">
                <div class="text-center">
                    <div class="course-prepare-info-each">
                        <label>Amount</label>
                        <span class="fa-2x">{{$jobPost->price}}</span>
                    </div>
...
<script>
    var options = {
        ...
        "description": "{{lms_setting('app_name')}} - Exam Payment - {{$jobPost->title}}",
                ...
                setTimeout(() => {
                    ...
                    $.post('{{route('ajax.verify_razorpay_payment')}}', {
                        ...
                        if (data.status == 'error') {
                            ...
                            setTimeout(() => {
                                show_loader();
                                window.location.href = "{{lms_job_post_slug($jobPost)}}";
                            }, 3000);
                        }
                    }, 'JSON');
                }, 100);
